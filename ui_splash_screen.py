...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>NHẬN DIỆN</strong> BIỂN SỐ XE", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Nguyễn Thanh Phong</strong>1711060497", None))
    # retranslateUi
